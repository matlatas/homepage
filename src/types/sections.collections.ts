...
export const companyBannerSection = defineCollection({
  loader: glob({
    pattern: "company-banner.{md,mdx}",
    base: "src/content/sections",
  }),
  schema: z.object({
    title: z.string(),
...
export const faqSection = defineCollection({
  ...
  schema: z.object({
    title: z.string(),
    description: z.string(),
    exclusive_open: z.boolean(),
    exclusive_open_group: z.string(),
    list: z
      .array(
        z.object({
          title: z.string(),
...
export const homeBannerSection = defineCollection({
  ...
  schema: z.object({
    ...
    description: z.string(),
    bg_image: z.string(),
    animating_images: z.array(z.string()),
    images: z.array(
      z.object({
        src: z.string(),
        alt: z.string(),
...
export const outTeamSection = defineCollection({
  loader: glob({
