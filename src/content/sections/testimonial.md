---
title: "Hva sier brukerne våre?"
description: "Vi lytter til våre brukere og er stolte av å dele tilbakemeldinger fra våre fornøyde kunder. Deres positive erfaringer med appen er en inspirasjon for oss."

button:
  enable: true
  label: "Se alle anmeldelser"
  link: "/review"
...
list:
  - name: "Cecilie"
    ...
    content: |
      “Perfekt for meg som student! bruker appen daglig for å finne gode tilbud på de varene jeg trenger😊 anbefaler for alle som er opptatt av og spare litt penger her og der (og alle fattige studenter!)”

  - name: "Kjell"
    designation: "Matpris-bruker i Google Play"
    content: |
